      ...
      <aside className="w-72 bg-sidebar border-r border-sidebar-border flex flex-col shadow-xl z-20">
        ...
        <div className="px-6 py-6 flex-1 overflow-y-auto">
          ...
          <nav className="space-y-1.5">
            ...
            {dbUser?.role === "ADMIN" && (
              <Link href="/admin" className="flex items-center px-4 py-3 rounded-xl text-sidebar-foreground hover:bg-sidebar-accent/50 hover:text-sidebar-foreground transition-all mt-4 border border-sidebar-accent">
